...
- Can be used in browser or in separate application
...
**NB**: If you are using a tutorial, make sure you know which story format it describes because syntax can be quite different
